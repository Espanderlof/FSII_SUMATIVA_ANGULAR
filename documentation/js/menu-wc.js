...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">albavets documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ManagerUsersComponent.html" data-type="entity-link" >ManagerUsersComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/RegistrarmeComponent.html" data-type="entity-link" >RegistrarmeComponent</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/DataInitializationService.html" data-type="entity-link" >DataInitializationService</a>
                                </li>
                                <li class="link">
